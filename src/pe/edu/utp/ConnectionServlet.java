 ...
 */
@WebServlet(name = "ConnectionServlet",urlPatterns = "/connected")
public class ConnectionServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        try {
            ...
            CallableStatement Cstmt = con.prepareCall("{call `Ingresar`(?,?,?,?,?)}");
            Cstmt.setString("ApPaterno", ApP);
            Cstmt.setString("ApMaterno", ApM);
            Cstmt.setString("Nombre", nom);
            Cstmt.setString("Sexo", s);
            Cstmt.setInt("Edad",e);
            Cstmt.execute();
